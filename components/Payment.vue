  ...
  <Modal @close="$emit('close')">
    <div class="bg-slate-200 p-8 rounded-xl w-full max-w-2xl">
      ...
      <form v-else @submit.prevent="handleSubmit">
        ...
        <button
          class="font-sans mt-4 w-full text-lg text-black h-12 px-16 rounded focus:outline-none focus:shadow-outline font-bold flex items-center justify-center bg-yellow-400 hover:bg-yellow-500 transition"
          :class="
